...
const AuthDialog = ({ children, ...props }) => {
  return (
    <Dialog>
      ...
      <DialogContent
        className="max-w-[90vw] lg:max-w-4xl md:min-w-[70vw] max-h-[80vh] lg:max-h-[95vh] my-auto bg-white shadow-lg rounded-2xl overflow-hidden flex p-0 inset-0 mx-auto"
